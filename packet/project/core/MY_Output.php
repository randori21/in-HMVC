...
class MY_Output extends CI_Output {
	...
	const TEMPLATE_ROOT = "../../assets/themes/";
        const TEMPLATE_BOSS = "../../assets/templates/";
	...
	function set_template($template_view){
        ...
        function set_template_boss($template_view){
		$this->set_mode(self::OUTPUT_MODE_TEMPLATE);
		$template_view = str_replace(".php", "", $template_view);
		$this->_template = self::TEMPLATE_BOSS . $template_view. "/template.php";
	}
