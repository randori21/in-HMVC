...
<div id="container" class="light">
	...
	<div id="body">			
		<p>Anda dapat menggunakan modul ini untuk:</p>
		<code>Installasi aplikasi yang diproduksi oleh ringkes.com</code>

		<p>Keterangan :</p>
		<code>Proses installasi dilakukan bertahap. Klik untuk <a href="<?php echo $alamat.'database';?>" class="topcoat-button--cta">Melanjutkan</a></code>
