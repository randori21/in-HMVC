...
<form action="<?php echo site_url('installer/tabel');?>" method="post">
	<div id="body">			
		<p>Nama Server:</p>
		<code><input type="text" name="host" class="topcoat-text-input" placeholder="localhost"></code>
	
		<p>Nama Database:</p>
		<code><input type="text" name="database"></code>
