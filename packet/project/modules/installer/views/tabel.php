...
<form action="<?php echo base_url('index.php/installer/aplikasi');?>" method="post">
	<div id="body">			
		<p>Keterangan:</p>
		<code>Tabel aplikasi akan diinstall ketika anda melanjutkan proses dengan cara klik tombol melanjutkan</code>

		<p>Aksi</p>
		<code><input type="reset" class="topcoat-button" name="batal" value="Batal" onclick="javascript:history.back()"><input class="topcoat-button--cta" type="submit" name="kirim" value="Melanjutkan"></code>
